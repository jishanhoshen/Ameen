<template>
        ...
        <div class="full-fluid">
          <div class="slider_wrapper">
            <div class="slider-block" style="background-image: url('assets/images/slider-background.jpg')">
              <div class="slider-content">
                <div class="container">
                  <div class="row align-items-center">
                    <div class="col-12 col-md-5 col-xl-6">
                      <div class="slider-text d-flex flex-column align-items-center align-items-md-start">
                        <h5 data-animation="fadeInUp" data-delay=".2s">Pure And Healthy</h5>
                        <h1 data-animation="fadeInUp" data-delay=".3s">Soyabean Oil</h1>
                        <h3 data-animation="fadeInUp" data-delay=".4s">Full <span> pakage</span></h3>
                        <a class="normal-btn" href="#" data-animation="fadeInUp" data-delay=".4s">Order now</a>
                      </div>
                    </div>
                    <div class="col-12 col-md-6">
                      <div class="slider-img" data-animation="zoomIn" data-delay=".1s">
                        <img src="assets/images/homepage01/slider_subbackground_1.png" alt="">
                        <div class="prallax-img">
                          <div id="img-block"><img class="img" src="assets/images/soyabeanoil.png" alt="" data-depth="1"></div>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="slider-content"> 
                <div class="container">
                  <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-12 col-md-6">
                      <div class="slider-img" data-animation="zoomIn" data-delay=".1s"><img src="assets/images/homepage01/slider_subbackground_1.png" alt=""><img class="img" src="assets/images/homepage01/slider_img_1.png" alt=""></div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-12 col-md-4">
                    <div class="benefit-detail d-flex flex-column align-items-center"><img class="benefit-img" src="assets/images/homepage01/benefit-icon1.png" alt="">
                      ...
                      <p class="benefit-describle">all over bangladesh</p>
                    </div>
                  </div>
                  <div class="col-12 col-md-4">
